...
<div className="text-2xl bg-gray-200 dark:bg-gray-503 mt-10 md:mt-12 h-120">
            <ul>
                <Link to="/settings/account-settings"><li className='bg-gray-400 dark:bg-gray-600 dark:text-white '>Account Settings</li></Link>
                 <li className='bg-gray-300 dark:bg-gray-400 dark:text-white' >LightMode v DarkMode <button onClick={() => setDark(prev => !prev)} className='border rounded-xl p-1 cursor-pointer hover:p-2'>{dark?"Switch to LightMode":"Switch to DarkMode"}</button> </li> 
            </ul>
